        ...
        <main className="p-4 sm:p-8 overflow-y-auto flex-1">
          ...
          <div className="relative overflow-hidden grid grid-cols-1 lg:grid-cols-2 gap-6 pt-10 bg-linear-to-br from-[#5CC8F1] via-[#10243A] to-[#061222] ">
            ...
            <div className="relative z-10 rounded-2xl overflow-hidden">
              ...
              <div className="relative z-40 px-4 sm:px-8 md:py-6 py-3 flex md:flex-col items-center text-center">
                <h2
                ...
                <div className=" md: flex flex-col flex flex-row px-4 sm:px-23 items-center sm:gap-7 gap-2 sm:-mt-4 w-full">
                  <div
            ...
            <div className="relative z-10 px-4 sm:px-6">
              ...
              <div className="space-y-3 sm:space-y-4 w-full max-w-[550px] pt-4 sm:pt-10 mx-auto">
                {courses.map((course) => (
                  <div
                    key={course.id}
