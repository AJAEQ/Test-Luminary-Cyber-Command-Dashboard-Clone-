...
export default function Clusters() {
  ...
  const discoveryStats = [{ label: "", value: "40%" }];
        ...
        <main className="p-4 sm:p-8 overflow-y-auto flex-1">
          <div className="flex items-center gap-3 mb-8">
            ...
            >
              <Image
                ...
                width={16}
                height={10}
                className="w-[16px] h-[10px] text-gray-400 hover:text-white"
              />
            </button>
          ...
          <div className="relative overflow-hidden grid grid-cols-1 lg:grid-cols-2 gap-6 pt-10 bg-linear-to-br from-[#5CC8F1] via-[#10243A] to-[#061222]">
              ...
              <div className="relative w-full min-h-[320px] sm:min-h-[480px] lg:min-h-[620px]">
                ...
                <div className="absolute inset-0 top-1/4">
                  <Image
                    ...
                    width={200}
                    height={200}
                    className="object-cover object-top opacity-80 mix-blend-screen w-[100px] h-full md:w-[200px] md:h-full"
                  />
                </div>
              </div>

              <div className="relative z-40 px-4  md:py-6 py-3 sm:px-8 flex flex-col items-center text-center">
              <h2
                className="text-[26px] sm:text-[48px] lg:text-[71.24px] font-bold bg-linear-to-br from-[#A4E1F8] via-[#5CB4C8] to-[#0C5062] text-transparent bg-clip-text"
                style={{ fontFamily: 'nasdaqer', letterSpacing: '-1.94px' }}
              >
                SECURITY
              </h2>
              <div className='flex flex-row  md:flex flex-col  items-center px-4 sm:px-23 sm:gap-7 gap-2 sm:-mt-4 w-full'>
                <div
                  ...
                  <div className="flex items-center gap-1 font-bold text-[15px] sm:text-[18.87px]">
                    <span className="text-[#FFAC33]">SES</span>{" "}
                    <span className="text-[#C18D40]">100</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="relative z-10 px-4 sm:px-6">
              ...
              <div className="space-y-1 sm:space-y-4 w-full max-w-[550px] pt-4 sm:pt-10 mx-auto">
                {courses.map((course) => (
                  <div
                    key={course.id}
                    className=" bg-linear-to-br from-cyan-500/60 via-cyan-500/15 to-transparent p-px transition-all"
                  >
                    <div className="bg-linear-to-br from-[#060E1B] to-[#061222] border border-white/5 p-3 sm:p-4 flex flex-col sm:flex-row items-start sm:items-center gap-3 sm:gap-4">
                      <div
                        className={`w-[52px] h-[52px] sm:w-16 sm:h-16 -mt-1.5 bg-linear-to-br ${
                          course.color ?? ""
                        } rounded-lg flex items-center justify-center text-2xl shrink-0`}
                      >
                        {course.image ? (
                          <Image
                            src={course.image}
                      ...
                      <div className="flex-1 min-w-0 w-full">
                        ...
                        <p className="text-[8.25px] text-gray-500 uppercase tracking-wider">
                          {course.subtitle}
                        </p>
                      </div>

                      <div className="flex w-full sm:w-auto items-center justify-between sm:justify-end gap-2 sm:gap-4">
                        <span className="text-[10px] sm:text-[10.98px] text-[#62D2F9] whitespace-nowrap">
                          {course.progress}
                        </span>
                        <button
                          className={`w-[120px] sm:w-[138.05px] h-[30px] sm:h-[31.38px] rounded-lg text-[10px] sm:text-[10.98px] font-bold uppercase tracking-wider ${
          ...
          <div className="p-4 sm:p-6 lg:p-10 flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between bg-[#040E1633] border-b-2 rounded-b-md border-gray-900 border-x-2">
                ...
                {discoveryStats.map((stat, index) => (
                  <div key={stat.label}>
                    ...
                    <div className="flex gap-2">
                      ...
                      <p className="text-[#E2E8FF] text-[12.72px] mt-1.5">
                        {stat.value}
                      </p>
                    </div>
                  </div>
            ...
            <div className="flex items-center justify-end gap-4">
              <button
                ...
                className="relative overflow-hidden w-full sm:w-[174px] h-[40px] bg-linear-to-br from-[#F6743E] via-[#D42525] to-[#D42525] text-[#E2E8FF] text-xs rounded-md border-[#FFFFFF99] border-[1.06px] font-semibold tracking-[0.2em] uppercase shadow-[13px_3px_24px_rgba(255,100,100,0.55)]"
              >
                Withdraw
              </button>
            </div>
