      ...
      <header className="px-3 sm:px-6 py-3 sm:py-4 flex flex-row items-start sm:items-center justify-between gap-3 sm:gap-0">
        ...
        <div className="flex items-center gap-4 sm:gap-6 w-full sm:w-auto justify-end">
          ...
          <Image
            ...
            width={0}
            height={0}
            className="w-4 h-4 sm:w-5 sm:h-5 text-gray-400 cursor-pointer hover:text-cyan-400"
          />
          <div className="relative">
            <Image
              ...
              width={0}
              height={0}
              className="w-3 h-2.5 sm:w-[16.5px] sm:h-[12px] text-gray-400 cursor-pointer hover:text-cyan-400"
            />
          ...
          <Image
            ...
            width={0}
            height={0}
            className="w-4 h-4 sm:w-[18px] sm:h-[18px] text-gray-400 cursor-pointer hover:text-cyan-400"
          />
          <button className="text-[#DF303399] text-xs sm:text-[14px] font-semibold flex items-center gap-1 sm:gap-2 hover:text-red-400 border-[#E2E8FF0D] border-2 rounded-xl px-2 sm:px-5 py-2 sm:py-3 whitespace-nowrap">
            <Image
              ...
              width={0}
              height={0}
              className="w-4 h-4 sm:w-[18px] sm:h-[18px] text-[#DF303399] cursor-pointer hover:text-cyan-400"
            />
